...
$(function () {
  ...
  function updateCheckbox(selector, mi_did, device_list, authReady) {
    ...
    if (device_list.length == 0) {
      const loginTips = authReady
        ? `<div class="login-tips">未发现可用的小爱设备，请确认 OAuth2 Token 是否有效，或在米家 App 重新扫码登录。</div>`
        : `<div class="login-tips">未发现可用的小爱设备，请先完成 OAuth2 扫码登录。</div>`;
