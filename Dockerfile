...
# Runtime secrets are injected via environment/.env:
#   HTTP_AUTH_HASH (bcrypt hash) — takes priority
#   HTTP_AUTH_PASSWORD (plaintext) — auto-generates runtime hash on start if hash not provided
